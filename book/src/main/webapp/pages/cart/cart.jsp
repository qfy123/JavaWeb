				...
				var count=this.value;
				 if (confirm("你确定要修改吗？")){
					location.href="http://localhost:8080/book/cartServlet?action=updateCount&id="+id+"&count="+count;
				 	...
				 	//defaultValue：表单项dom对象的属性，表示默认的value属性值
	...
	<div id="main">
		...
		<table>
			...
			<c:if test="${empty sessionScope.cart.items}">
				<tr>
					<td colspan="5"><a href="index.jsp"> 亲，当前购物车没有商品，快去选购吧！</a></td>
				</tr>
			...
			<c:if test="${not empty sessionScope.cart.items}">
				...
				<tr>
					...
					<td><input class="updateCount" style="width: 30px" type="text" value="${entry.value.count}" bookId="${entry.value.id}"></td>
